...
**프레임 판정**: 해당 기사가 자사를 어떤 "서사 상자" 에 넣고 있는지 한 문구로. 가능한 프레임 예시:
- "휴머노이드 국내 선도"
- "삼성 연계 성장"
- "해외 매출 확대 도전"
- "협동로봇 저가 경쟁 압박"
...
```json
{
  ...
  "summary_for_orchestrator": "5월 타임라인 42건 검토. significance high 1건 key-events 승격. patterns-observed 갱신: 프레임 Top3 변동 (삼성 연계 ↑)."
}
```
